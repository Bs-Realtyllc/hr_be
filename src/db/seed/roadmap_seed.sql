...
SELECT p.id, t.title, t.is_complete, t.sort_order
FROM projects p,
(SELECT 'Brand identity and design system',                      1, 1 UNION ALL
...
SELECT p.id, t.title, t.is_complete, t.sort_order
FROM projects p,
(SELECT 'Product scope and line-of-business mapping',           1,  1 UNION ALL
...
SELECT p.id, t.title, t.is_complete, t.sort_order
FROM projects p,
(SELECT 'LMS platform architecture design',                     1,  1 UNION ALL
...
SELECT p.id, t.title, t.is_complete, t.sort_order
FROM projects p,
(SELECT 'Threat-model review and initial hardening',            1,  1 UNION ALL
...
SELECT p.id, t.title, t.is_complete, t.sort_order
FROM projects p,
(SELECT 'Employee directory and profile management',            1,  1 UNION ALL
...
SELECT p.id, t.title, t.is_complete, t.sort_order
FROM projects p,
(SELECT 'Define KPIs and data sources across platforms',        1,  1 UNION ALL
